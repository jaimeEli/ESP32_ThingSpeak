...
#define SECRET_SSID "Totalplay-2467"    // replace MySSID with your WiFi network name
#define SECRET_PASS "8466198497Santa" // replace MyPassword with your WiFi password
